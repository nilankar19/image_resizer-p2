...
(n = this),
  (t = function () {
    ...
    function Rt(o, r, t, u) {
      ...
      function k() {
        var n = o.awfullys
          .map(function (n) {
            n = n.awfully.Components.Slides.getAt(r);
            return n ? n.slide.id : "";
          })
          .join(" ");
    ...
    var Ut = Object.freeze({
        ...
        Sync: function (i, n, t) {
          ...
          function e() {
            var n, t;
            i.awfullys.forEach(function (n) {
              n.isParent || (f(i, n.awfully), f(n.awfully, i));
            }),
              r &&
                ((n = Q(i)),
                (t = n.on)(Mn, s),
    ...
    t = (function () {
      ...
      return (
        ...
        (n.sync = function (n) {
          return (
            this.awfullys.push({ awfully: n }),
            n.awfullys.push({ awfully: this, isParent: !0 }),
            this.state.is(3) &&
  ...
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((n = "undefined" != typeof globalThis ? globalThis : n || self).awfully =
        t());
...
document.addEventListener( 'DOMContentLoaded', function() {
              var testimonialsSlider = new awfully( '.awfully-review-testimonials-slider', {
                type: 'slide',
                perMove: 1,
                arrows: true,
                pagination: false,
              ...
              function classifySlides(newIndex) {
                var slides = document.querySelectorAll('.awfully__slide');
